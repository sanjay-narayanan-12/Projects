package com.sanjaynarayanan.spring.thymeleaf.controller;
...
import com.sanjaynarayanan.spring.thymeleaf.entity.Tutorial;
import com.sanjaynarayanan.spring.thymeleaf.repository.TutorialRepository;
...
public class TutorialController {
	...
	public String getAll(Model model, @Param("keyword") String keyword) {
		try {
			...
			Tutorial tutorial1 = new Tutorial("Tutorial 1", "Tutorial 1 description", 2, true);
			Tutorial tutorial2 = new Tutorial("Tutorial 2", "Tutorial 2 description", 2, true);
